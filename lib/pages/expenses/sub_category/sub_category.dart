...
class ESubCategory extends GetView<ESCatCon> {
  const ESubCategory({super.key});
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              Header(
                pageName: 'Expenses Sub Category',
                searchBar: TextField(
                  onChanged: (text) {
                  ...
                  Expanded(
                    ...
                    child: Column(
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            if (Utils.access.contains(
                                Utils.initials("expenses Sub Category", 1)))
                              MButton(
                                onTap: () {
                            ...
                            Obx(() => MyRichText(
                                ...
                                mainText: "Expenses Sub Category Record ",
                        ...
                        if (Utils.access.contains(
                                Utils.initials("expenses Sub Category", 0)))
                        SizedBox(
                            height: myHeight(context, 1.19),
                            child: const ESCTable())
                      ],
                    ),
                  ),
                ],
