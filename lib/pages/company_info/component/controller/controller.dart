...
class CompanyInfoCon extends GetxController {
  ...
  //       request.fields['name'] = name.text.capitalize!;
  //       request.fields['action'] = "add_category";
  //       request.fields['status'] = active.value ? "1" : "0";
  //       request.files.addAll([
  //         http.MultipartFile.fromBytes("image", imgBytes, filename: img.value),
  //         http.MultipartFile.fromBytes("banner", bytes, filename: banner.value),
  //       ]);
  ...
  //         isSave.value = false;
  //         Utils().showInfo(saved, "Category");
  //       } else if (jsonDecode(result) == "duplicate") {
  //         isSave.value = false;
  //         Utils().showError(duplicate, "Category");
  //       } else if (jsonDecode(result) == "false") {
  //         isSave.value = false;
  //         Utils().showError(notSaved, "Category");
  //       } else {
  //         isSave.value = false;
  //       }
  //       isSave.value = false;
  ...
  //       isSave.value = false;
  //       print.call(e);
  //       // Utils().showError(noInternet, "Category");
  //     }
  //   }
  // }
