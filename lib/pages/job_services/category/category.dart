...
class ServiceCategory extends GetView<ServiceCatCon> {
                  ...
                  Expanded(
                    ...
                    child: Column(
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            if (Utils.access.contains(
                                Utils.initials("Products Category", 1)))
                              MButton(
                                onTap: () {
                            ...
                            Obx(() => MyRichText(
                                ...
                                mainText: "Products Category Record ",
                        ...
                        if (Utils.access
                            .contains(Utils.initials("Products Category", 0)))
                          SizedBox(
