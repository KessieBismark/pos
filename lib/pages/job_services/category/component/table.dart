...
class SCTable extends GetView<ServiceCatCon> {
  const SCTable({super.key});
                  ...
                  cells: [
                    ...
                    DataCell(Row(
                      children: [
                        if (Utils
                            .access
                            .contains(Utils.initials("Products Category", 2)))
                        ...
                        if (Utils
                            .access
                            .contains(Utils.initials("Products Category", 3)))
