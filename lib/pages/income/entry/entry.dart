...
class InEntry extends GetView<InEntryCon> {
  const InEntry({super.key});
                  ...
                  Expanded(
                    ...
                    child: Column(
                      children: [
                          ...
                          Row(
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  Utils.userRole == "Super Admin"
                                      ? MButton(
                                          onTap: () => closeSalesDialog(),
                                          title: "Close Sales",
                                          color: Colors.grey,
                                        ).hPadding9
                                      : Container(),
                                  if (Utils.access.contains(
                                      Utils.initials("income Entry", 4)))
                                    MButton(
                                      onTap: () {
                              ...
                              Obx(() => MyRichText(
                                  ...
                                  mainText: "Income Record ",
                                  subText: "(${controller.ssList.length})")),
                              Row(
                                children: [
                                  DropDownText2(hint: "Branch", label: "Branch",controller: controller.branch, list: controller.bList),
                                  IconButton(
                                              ...
                                              if (controller
                                                ...
                                                Get.to(() => IncomePrint(
                                                      attendanceList:
                                                          controller.ssList,
                                                      title:
                                                          "Income Entry Report from ${controller.selectedDate}",
                                                    ));
                                              } else {
                                                Utils().showError(
                        ...
                        if (Utils.access
                            .contains(Utils.initials("income Entry", 0)))
                          SizedBox(
        ...
        children: [
          Obx(() => controller.isB.value
              ...
              : DropDownText2(
                      ...
                      onChange: (val) {
                        controller.closeSales.text = "";
                        controller.branch=DropDownModel(id: val!.id, name: val.name) ;
                        controller.getCloseSales(val.toString());
                      },
                      list: controller.bList)
                  .padding9),
          Obx(() => controller.isCloseSale.value
              ? const MWaiting()
              : DropDownText(
                  hint: "Select month and year",
                  label: "Select month and year",
                  controller: controller.closeSales,
                  onChange: (val) {
                    controller.closeSales.text = val.toString();
                  },
                  list: controller.salesPending)).padding9,
          const Divider(),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              MButton(
                onTap: () => controller.calculateSales(),
