...
class InTable extends GetView<InEntryCon> {
  const InTable({super.key});
                ...
                (index) => DataRow(
                  ...
                  cells: [
                    ...
                    DataCell(controller.ssList[index].entryDate
                        .toString()
                        .toAutoLabel()),
                    DataCell(controller.ssList[index].sub == "Sales"
                        ? Container()
                        : Row(
                            children: [
                              if (Utils.access
                                  .contains(Utils.initials("income Entry", 2)))
                                IconButton(
                                  onPressed: () {
                                    ...
                                    controller.branch = DropDownModel(
                                        ...
                                        name: controller.ssList[index].branch);
                              ...
                              if (Utils.access
                                  .contains(Utils.initials("income Entry", 4)))
                                IconButton(
                                    onPressed: () {
                                      controller.type.text =
                                          controller.ssList[index].type;
                              ...
                              if (Utils.access
                                  .contains(Utils.initials("income Entry", 3)))
