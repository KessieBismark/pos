...
class InTable extends GetView<InCatCon> {
              ...
              rows: List.generate(
                ...
                (index) => DataRow(
                  ...
                  cells: [
                    ...
                    DataCell(int.parse( controller.catList[index].id) == 4
                        ? Container()
                        : Row(
                            children: [
                              if (Utils.access.contains(
                                  Utils.initials("income Category", 2)))
                                IconButton(
                                  onPressed: () {
                              ...
                              if (Utils.access.contains(
                                  Utils.initials("income Category", 3)))
