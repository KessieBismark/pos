...
class InCategory extends GetView<InCatCon> {
                    ...
                    child: Column(
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            if (Utils.access
                                .contains(Utils.initials("income Category", 1)))
                              MButton(
                                onTap: () {
                            ...
                            Obx(() => MyRichText(
                                ...
                                mainText: "Income Category Record ",
                        ...
                        if (Utils.access
                                .contains(Utils.initials("income Category", 0)))
                        SizedBox(
