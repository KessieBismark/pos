...
class InSubCategory extends GetView<InSCatCon> {
  const InSubCategory({super.key});
                  ...
                  Expanded(
                    ...
                    child: Column(
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            if (Utils.access.contains(
                                Utils.initials("income Sub Category", 1)))
                              MButton(
                                onTap: () {
                            ...
                            Obx(() => MyRichText(
                                ...
                                mainText: "Income Sub Category Record ",
                        ...
                        if (Utils.access
                            .contains(Utils.initials("income Sub Category", 0)))
                          SizedBox(
                              height: myHeight(context, 1.19),
                              child: const InSCTable())
                      ],
                    ),
                  ),
                ],
