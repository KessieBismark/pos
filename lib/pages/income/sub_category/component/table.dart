...
class InSCTable extends GetView<InSCatCon> {
  const InSCTable({super.key});
              ...
              rows: List.generate(
                ...
                (index) => DataRow(
                  ...
                  cells: [
                    ...
                    DataCell(int.parse(controller.ssList[index].id) == 4
                        ? Container()
                        : Row(
                            children: [
                              if (Utils.access.contains(
                                  Utils.initials("income Sub Category", 2)))
                                IconButton(
                                  onPressed: () {
                              ...
                              if (Utils.access.contains(
                                  Utils.initials("income Sub Category", 3)))
