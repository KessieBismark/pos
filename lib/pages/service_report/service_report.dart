...
import 'component/controller/controler.dart';
import 'component/controller/table.dart';
import 'component/print/report.dart';

class SReport extends GetView<SRCon> {
  const SReport({super.key});
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            if (Utils.access
                                .contains(Utils.initials("sales report", 1)))
                              Obx(() => MyRichText(
                                        ...
                                        if (controller.ssList.isNotEmpty) {
                                          Get.to(() => SalesPrint(
                                                attendanceList:
                                                    controller.ssList,
                                                title:
                                                    "Sales Report From ${controller.selectedDate}",
                                              ));
                                        } else {
                                          Utils().showError(
                        ...
                        if (Utils.access
                            .contains(Utils.initials("sales report", 0)))
                          SizedBox(
